...
def crear_frame_crear_cuenta(base: ctk.CTk):
    """
    Crea un nuevo marco para crear una cuenta.

    Args:
        base: La ventana base en la que se creará el nuevo marco.
...
def opciones_crear_cuenta(ventana_crear_cuenta: ctk.CTkToplevel):
    """
    Crea las opciones para crear una cuenta en el marco de crear cuenta.

    Args:
        ventana_crear_cuenta: La ventana en la que se mostrarán las opciones.
...
def validar_datos(entries: dict, ventana_crear_cuenta: ctk.CTkToplevel):
    ...
    Args:
        entries: Una lista de los campos de entrada de datos.
        ventana_crear_cuenta: La ventana de creación de cuenta.
    ...
    try:
        ...
        if contrasena == confirmar_contrasena:
            if usuario.lower() not in [usuario[3].lower() for usuario in obtener_usuarios_bd()]:
                ...
                mostrar_mensaje("Cuenta creada",
                                f"La cuenta de {tipo_usuario} con el usuario {usuario} ha sido creada exitosamente")
