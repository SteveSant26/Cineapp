...
def editar_perfil(base: ctk.CTk) -> None:
    """
    ...
    boton_guardar = ctk.CTkButton(frame_formulario, text="Guardar",
                                  ...
                                  height=40,
                                  font=("Arial", 16, "bold"),
                                  command=lambda: guardar_cambios(base, entries))
    ...
    boton_eliminar = ctk.CTkButton(frame_formulario, text="Eliminar cuenta",
                                   ...
                                   height=40,
                                   font=("Arial", 16, "bold"),
                                   command=lambda: eliminar_cuenta(base))
    boton_eliminar.grid(row=6, column=0, columnspan=2, pady=15)
    
def guardar_cambios(base: ctk.CTk, entries: list) -> None:
    """
...
def eliminar_cuenta(base: ctk.CTk) -> None:
    """
