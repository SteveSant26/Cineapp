...
def crear_asientos(base: ctk.CTk) -> None:
    """
    ...
    try:
        ...
        for (i, j), asiento in asientos.items():
            if (i, j) in base.asientos_seleccionados:
                ...
                if base.tipo_usuario == "cliente" and base.asientos_cliente and (i, j) in base.asientos_cliente:
...
def actualizar_asientos(base: ctk.CTk) -> None:
    """
    Actualiza el estado de los asientos en la sala basándose en la función actual y el usuario.
    ...
    if base.asientos:
        if base.tipo_usuario == "cliente":
            ...
            base.asientos_cliente = asientos_cliente if asientos_cliente else {}
